...
var PreventUnsavedChanges = /** @class */ (function () {
    ...
    PreventUnsavedChanges.prototype.canDeactivate = function (component) {
        if (component.editForm.dirty) {
            return confirm('Are you sure you want to continue, pal? Any unsaved process will be lost');
        }
        return true;
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.deletePhotos = function (userId, photoId) {
    ...
    UserService.prototype.getMessages = function (id, page, itemsPerPage, messageContainer) {
        ...
        return this.http.get(this.baseUrl + 'user/' + id + '/messages', { observe: 'response', params: params })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
            paginatedResult.result = response.body;
            if (response.headers.get('Pagination') !== null) {
                paginatedResult.pagination = JSON.parse(response.headers.get('Pagination'));
    ...
    UserService.prototype.getMessageThread = function (id, recipientId) {
        return this.http.get(this.baseUrl + 'user/' + id + '/messages/thread/' + recipientId);
    };
...
/* harmony import */ var _material_icon_material_icon_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./material-icon/material-icon.component */ "./src/app/material-icon/material-icon.component.ts");
...
/* harmony import */ var _home_routes__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./home/routes */ "./src/app/home/routes.ts");
...
/* harmony import */ var _resolver_member_detail_resolver__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./_resolver/member-detail.resolver */ "./src/app/_resolver/member-detail.resolver.ts");
/* harmony import */ var _resolver_member_list_resolver__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./_resolver/member-list.resolver */ "./src/app/_resolver/member-list.resolver.ts");
...
/* harmony import */ var _resolver_member_edit_resolver__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./_resolver/member-edit.resolver */ "./src/app/_resolver/member-edit.resolver.ts");
...
/* harmony import */ var _resolver_messages__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./_resolver/messages */ "./src/app/_resolver/messages.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _material_icon_material_icon_component__WEBPACK_IMPORTED_MODULE_6__["MaterialIconComponent"],
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_15__["RouterModule"].forRoot(_home_routes__WEBPACK_IMPORTED_MODULE_16__["appRoutes"]),
            ...
            providers: [
                ...
                _resolver_member_detail_resolver__WEBPACK_IMPORTED_MODULE_23__["MemberDetailResolver"],
                _resolver_messages__WEBPACK_IMPORTED_MODULE_33__["MessagesResolver"],
                _resolver_member_list_resolver__WEBPACK_IMPORTED_MODULE_24__["MemberListResolver"],
...
/* harmony import */ var _resolver_messages__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../_resolver/messages */ "./src/app/_resolver/messages.ts");
...
var appRoutes = [
    { path: '', component: _home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'messages', component: _messages_messages_component__WEBPACK_IMPORTED_MODULE_3__["MessagesComponent"], resolve: { messages: _resolver_messages__WEBPACK_IMPORTED_MODULE_12__["MessagesResolver"] } },
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_2__["ListsComponent"], resolve: { users: _resolver_lists_resolver__WEBPACK_IMPORTED_MODULE_11__["ListsResolver"] } },
        ]
    },
...
/***/ "./src/app/material-icon/material-icon.component.css":
/*!***********************************************************!*\
  !*** ./src/app/material-icon/material-icon.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/app/material-icon/material-icon.component.html":
/*!************************************************************!*\
  !*** ./src/app/material-icon/material-icon.component.html ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/material-icon/material-icon.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/material-icon/material-icon.component.ts ***!
  \**********************************************************/
...
var MaterialIconComponent = /** @class */ (function () {
    ...
    MaterialIconComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./material-icon.component.html */ "./src/app/material-icon/material-icon.component.html"),
            styles: [__webpack_require__(/*! ./material-icon.component.css */ "./src/app/material-icon/material-icon.component.css")]
        }),
        __metadata("design:paramtypes", [])
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        var _this = this;
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function (date) {
    ...
    MemberCardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"],
...
var MemberMessagesComponent = /** @class */ (function () {
    ...
    MemberMessagesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"],
...
var PhotoEditorComponent = /** @class */ (function () {
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this photo?', function () {
            _this.userService.deletePhotos(_this.authService.decodedToken.nameid, id).subscribe(function () {
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.deleteMessages = function (id) {
        var _this = this;
    ...
    MessagesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"],
            _services_alertify_service__WEBPACK_IMPORTED_MODULE_4__["AlertifyService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], MessagesComponent);
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.logOut = function () {
        ...
        this.alertify.message('User logget out');
        this.router.navigate(['/home']);
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authservice.register(this.user).subscribe(function () {
                _this.alertify.success('Registaration succesfull');
            }, function (error) {
                _this.alertify.error(error);
            }, function () {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"],
            _services_alertify_service__WEBPACK_IMPORTED_MODULE_2__["AlertifyService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], RegisterComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Weronika\Documents\DATINGAPP\DatinApp\datingapp-spa\src\main.ts */"./src/main.ts");
